...
// StageKind, StageAttribute, StageUniform, StageOutput and StageTexture
// describe a compiled graphics stage. A caller reads them from a generated
// [Stage] and never builds one.
type (
	...
	StageTexture   = kernel.StageTexture
)
