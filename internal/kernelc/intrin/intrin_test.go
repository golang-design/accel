...
func TestNamesAndDigestAreStable(t *testing.T) {
	...
	want := []string{
		...
		"accel.Thread.SubgroupAndI32",
		"accel.Thread.SubgroupAndU32",
		...
		"accel.Thread.SubgroupMulF32",
		"accel.Thread.SubgroupMulI32",
		"accel.Thread.SubgroupMulU32",
		"accel.Thread.SubgroupOrI32",
		"accel.Thread.SubgroupOrU32",
		...
		"accel.Thread.SubgroupXorI32",
		"accel.Thread.SubgroupXorU32",
