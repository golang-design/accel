...
func TestCommittedFileIsFresh(t *testing.T) {
	...
	want := []string{"Add", "AtomicAddF32", "AtomicOps", "AtomicOpsI32", "AttentionDecode", "AttentionDecodeBatched", "AttentionDecodeF16", "AttentionDecodePaged", "AttentionDecodePagedF16", "AttentionPrefill", "AttentionPrefillF16", "AttentionPrefillPaged", "AttentionPrefillPagedF16", "AttentionRagged", "AttentionRaggedF16", "AttributeVS", "Ballot", "BitReduce", "BlitFS", "CastBF16ToF32", "CastF16ToF32", "CastF32ToF16", "CountAbove", "CountWorkgroups", "DiscardFS", "DispatchShape", "DisplacedVS", "ElemAdd", "ElemBias", "ElemMul", "ElemScale", "Exchange", "FloatReduce", "FullScreenVS", "GatherRows", "GatherRowsF16", "GeometryVS", "GroupedMatMul", "GroupedMatVec", "HalfTriangleVS", "Histogram", "IndexShape", "IndexedFS", "IndexedVS", "IntReduce", "LinearAttention", "LinearTiled", "LogitBias", "MatMulTiled", "MatMulTiledF32", "MatMulTiledF32F16", "MatVec", "MatVecF32", "MatVecF32F16", "MatrixShapes", "MulReduce", "Normalize", "Pack", "PairAverage", "PenaltyApply", "PenaltyApplyRows", "PenaltyClear", "PenaltyClearRows", "PenaltyCount", "PenaltyCountRows", "PerspectiveFS", "PerspectiveVS", "PublishShared", "PublishStorage", "QuantMatMul", "QuantMatMulF32", "QuantMatMulInt4", "QuantMatMulTiled", "QuantMatMulTiledF32", "QuantMatVec", "QuantMatVecF32", "QuantMatVecInt4", "QuantRows", "RMSNorm", "ReduceLoop", "ReduceSum", "ReduceUnrolled", "RoPE", "RowFS", "SampleArgmax", "SampleCategorical", "SampleRows", "SampledFS", "SaturatingConvert", "Scale", "ScaleRows", "ScaledVS", "ScatterRows", "ScatterRowsF16", "SegmentOffsets", "SegmentSum", "ShadeFS", "ShapeBoundedSum", "SiLU", "Softmax", "SolidFS", "SubgroupPublish", "SubgroupReduce", "SubgroupReduceFallback", "SubgroupScan", "SubgroupScanFallback", "SubgroupShuffleMix", "SubgroupShuffleMixFallback", "SubgroupStagger", "SwiGLU", "TintFS", "TintedFS", "TopKMask", "TopKMaskRows", "TopPMask", "TopPMaskRows", "TopRowFS", "Transform"}
