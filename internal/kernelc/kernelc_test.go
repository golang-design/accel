...
func TestCommittedFileIsFresh(t *testing.T) {
	...
	want := []string{"Add", "AtomicOps", "AttentionDecode", "AttentionDecodeBatched", "AttentionDecodeF16", "AttentionDecodePaged", "AttentionDecodePagedF16", "AttentionPrefill", "AttentionPrefillF16", "AttentionPrefillPaged", "AttributeVS", "CastF16ToF32", "CastF32ToF16", "CountAbove", "CountWorkgroups", "ElemAdd", "ElemMul", "ElemScale", "Exchange", "FullScreenVS", "GatherRows", "GatherRowsF16", "GeometryVS", "HalfTriangleVS", "Histogram", "LinearTiled", "MatMulTiled", "MatMulTiledF32", "MatVec", "Normalize", "Pack", "QuantMatMul", "QuantMatVec", "QuantRows", "RMSNorm", "ReduceLoop", "ReduceSum", "ReduceUnrolled", "RoPE", "SampleArgmax", "SampleCategorical", "Scale", "ScaledVS", "ScatterRows", "ScatterRowsF16", "SegmentSum", "ShadeFS", "SiLU", "Softmax", "SolidFS", "SubgroupReduce", "SubgroupReduceFallback", "SwiGLU", "TintFS", "TintedFS", "TopKMask", "TopPMask", "Transform"}
