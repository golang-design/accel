...
func TestCommittedFileIsFresh(t *testing.T) {
	...
	want := []string{"Add", "AtomicOps", "CountAbove", "Exchange", "Histogram", "Normalize", "ReduceLoop", "ReduceSum", "ReduceUnrolled", "Scale", "SegmentSum", "SubgroupReduce", "SubgroupReduceFallback", "Transform"}
