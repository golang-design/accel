...
func TestCommittedFileIsFresh(t *testing.T) {
	...
	want := []string{"Add", "AtomicOps", "AttentionDecode", "AttentionPrefill", "CastF16ToF32", "CastF32ToF16", "CountAbove", "CountWorkgroups", "ElemAdd", "ElemMul", "ElemScale", "Exchange", "GatherRows", "Histogram", "LinearTiled", "MatMulTiled", "MatVec", "Normalize", "QuantMatMul", "QuantRows", "RMSNorm", "ReduceLoop", "ReduceSum", "ReduceUnrolled", "RoPE", "SampleArgmax", "SampleCategorical", "Scale", "ScatterRows", "SegmentSum", "SiLU", "Softmax", "SubgroupReduce", "SubgroupReduceFallback", "SwiGLU", "Transform"}
