...
func TestCommittedFileIsFresh(t *testing.T) {
	...
	want := []string{"Add", "AtomicOps", "CountAbove", "CountWorkgroups", "Exchange", "Histogram", "MatMulTiled", "Normalize", "RMSNorm", "ReduceLoop", "ReduceSum", "ReduceUnrolled", "Scale", "SegmentSum", "Softmax", "SubgroupReduce", "SubgroupReduceFallback", "Transform"}
