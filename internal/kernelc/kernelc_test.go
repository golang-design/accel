...
func TestCommittedFileIsFresh(t *testing.T) {
	...
	want := []string{"Add", "AtomicOps", "CountAbove", "CountWorkgroups", "Exchange", "Histogram", "MatMulTiled", "Normalize", "ReduceLoop", "ReduceSum", "ReduceUnrolled", "Scale", "SegmentSum", "SubgroupReduce", "SubgroupReduceFallback", "Transform"}
