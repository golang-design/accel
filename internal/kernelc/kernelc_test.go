...
func TestCommittedFileIsFresh(t *testing.T) {
	...
	want := []string{"Add", "AtomicOps", "CountAbove", "Exchange", "Histogram", "MatMulTiled", "Normalize", "ReduceLoop", "ReduceSum", "ReduceUnrolled", "Scale", "SegmentSum", "SubgroupReduce", "SubgroupReduceFallback", "Transform"}
