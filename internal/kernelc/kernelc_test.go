...
func TestCommittedFileIsFresh(t *testing.T) {
	...
	want := []string{"Add", "AtomicOps", "AttentionDecode", "AttentionDecodeBatched", "AttentionDecodeF16", "AttentionDecodePaged", "AttentionDecodePagedF16", "AttentionPrefill", "AttentionPrefillF16", "AttentionPrefillPaged", "AttributeVS", "BlitFS", "CastBF16ToF32", "CastF16ToF32", "CastF32ToF16", "CountAbove", "CountWorkgroups", "DisplacedVS", "ElemAdd", "ElemMul", "ElemScale", "Exchange", "FullScreenVS", "GatherRows", "GatherRowsF16", "GeometryVS", "HalfTriangleVS", "Histogram", "LinearTiled", "MatMulTiled", "MatMulTiledF32", "MatMulTiledF32F16", "MatVec", "Normalize", "Pack", "QuantMatMul", "QuantMatMulF32", "QuantMatVec", "QuantMatVecF32", "QuantRows", "RMSNorm", "ReduceLoop", "ReduceSum", "ReduceUnrolled", "RoPE", "SampleArgmax", "SampleCategorical", "SampledFS", "Scale", "ScaledVS", "ScatterRows", "ScatterRowsF16", "SegmentSum", "ShadeFS", "SiLU", "Softmax", "SolidFS", "SubgroupReduce", "SubgroupReduceFallback", "SubgroupScan", "SubgroupScanFallback", "SubgroupShuffleMix", "SubgroupShuffleMixFallback", "SwiGLU", "TintFS", "TintedFS", "TopKMask", "TopPMask", "Transform"}
