...
func attentionDecodeCoop(t accel.Thread, d AttnDims, q []float32, k []float32, v []float32, lengths []uint32, out []float32, scores *[128]float32, red *[128]float32, f *attentionDecodeFrame, frame *kernelabi.Frame, tr *kernelabi.SharedTracker) bool {
	for {
		...
		case 3:
			f.pc = 4
			frame.Barrier = kernelabi.BarrierID{Index: 3, Pos: "attention.go:169:3"}
			return true
		case 4:
		...
		case 5:
			f.pc = 6
			frame.Barrier = kernelabi.BarrierID{Index: 5, Pos: "attention.go:172:3"}
			return true
		case 6:
		...
		case 8:
			f.pc = 9
			frame.Barrier = kernelabi.BarrierID{Index: 8, Pos: "attention.go:178:4"}
			return true
		case 9:
		...
		case 12:
			f.pc = 13
			frame.Barrier = kernelabi.BarrierID{Index: 12, Pos: "attention.go:195:3"}
			return true
		case 13:
			tr.Write(0, int(f.lane2))
		...
		case 14:
			f.pc = 15
			frame.Barrier = kernelabi.BarrierID{Index: 14, Pos: "attention.go:198:3"}
			return true
		case 15:
		...
		case 17:
			f.pc = 18
			frame.Barrier = kernelabi.BarrierID{Index: 17, Pos: "attention.go:204:4"}
			return true
		case 18:
...
var AttentionDecodeKernel = kernelabi.Kernel{
	...
	Digest:    "fec3d8114e8ff704a77f8de3dd5c4c82",
	Generator: kernelabi.Version,
	MSL: `#include <metal_stdlib>
using namespace metal;
#pragma METAL fp contract(off)
...
kernel void AttentionDecode(
    ...
    float l = float(0);
    float o = float(0);
    for (uint base = uint(0); (base < kvLen); base = (base + uint(128))) {
        uint pos = (base + lane);
...
func attentionDecodeF16Coop(t accel.Thread, d AttnDims, q []float32, k []accel.Float16, v []accel.Float16, lengths []uint32, out []float32, scores *[128]float32, red *[128]float32, f *attentionDecodeF16Frame, frame *kernelabi.Frame, tr *kernelabi.SharedTracker) bool {
	for {
		...
		case 3:
			f.pc = 4
			frame.Barrier = kernelabi.BarrierID{Index: 3, Pos: "attention.go:319:3"}
			return true
		case 4:
			tr.Write(0, int(f.lane2))
			scores[f.lane2] = f.s11
		...
		case 5:
			f.pc = 6
			frame.Barrier = kernelabi.BarrierID{Index: 5, Pos: "attention.go:322:3"}
			return true
		case 6:
			f.stride15 = uint32(64)
			f.pc = 10
		...
		case 8:
			f.pc = 9
			frame.Barrier = kernelabi.BarrierID{Index: 8, Pos: "attention.go:328:4"}
			return true
		case 9:
			f.stride15 = (f.stride15 / uint32(2))
			f.pc = 10
		...
		case 12:
			f.pc = 13
			frame.Barrier = kernelabi.BarrierID{Index: 12, Pos: "attention.go:345:3"}
			return true
		case 13:
			tr.Write(0, int(f.lane2))
			scores[f.lane2] = f.e19
		...
		case 14:
			f.pc = 15
			frame.Barrier = kernelabi.BarrierID{Index: 14, Pos: "attention.go:348:3"}
			return true
		case 15:
			f.stride20 = uint32(64)
			f.pc = 19
		...
		case 17:
			f.pc = 18
			frame.Barrier = kernelabi.BarrierID{Index: 17, Pos: "attention.go:354:4"}
			return true
		case 18:
			f.stride20 = (f.stride20 / uint32(2))
			f.pc = 19
...
var AttentionDecodeF16Kernel = kernelabi.Kernel{
	...
	Digest:    "caa40b9f6f797a156a2dcff5b285a7d0",
	Generator: kernelabi.Version,
	MSL: `#include <metal_stdlib>
using namespace metal;
#pragma METAL fp contract(off)
...
func attentionDecodeBatchedCoop(t accel.Thread, d BatchedDims, q []float32, k []float32, v []float32, pages []uint32, lengths []uint32, out []float32, scores *[128]float32, red *[128]float32, f *attentionDecodeBatchedFrame, frame *kernelabi.Frame, tr *kernelabi.SharedTracker) bool {
	for {
		...
		case 3:
			f.pc = 4
			frame.Barrier = kernelabi.BarrierID{Index: 3, Pos: "batched.go:120:3"}
			return true
		case 4:
			tr.Write(0, int(f.lane1))
		...
		case 5:
			f.pc = 6
			frame.Barrier = kernelabi.BarrierID{Index: 5, Pos: "batched.go:123:3"}
			return true
		case 6:
		...
		case 8:
			f.pc = 9
			frame.Barrier = kernelabi.BarrierID{Index: 8, Pos: "batched.go:129:4"}
			return true
		case 9:
		...
		case 12:
			f.pc = 13
			frame.Barrier = kernelabi.BarrierID{Index: 12, Pos: "batched.go:140:3"}
			return true
		case 13:
			tr.Write(0, int(f.lane1))
		...
		case 14:
			f.pc = 15
			frame.Barrier = kernelabi.BarrierID{Index: 14, Pos: "batched.go:143:3"}
			return true
		case 15:
		...
		case 17:
			f.pc = 18
			frame.Barrier = kernelabi.BarrierID{Index: 17, Pos: "batched.go:149:4"}
			return true
		case 18:
...
var AttentionDecodeBatchedKernel = kernelabi.Kernel{
	...
	Digest:    "b0dcc7f824703113b9696fd988e5ccc9",
	Generator: kernelabi.Version,
	MSL: `#include <metal_stdlib>
using namespace metal;
#pragma METAL fp contract(off)
...
func attentionDecodePagedCoop(t accel.Thread, d PagedDims, q []float32, k []float32, v []float32, pages []uint32, lengths []uint32, out []float32, scores *[128]float32, red *[128]float32, f *attentionDecodePagedFrame, frame *kernelabi.Frame, tr *kernelabi.SharedTracker) bool {
	for {
		...
		case 3:
			f.pc = 4
			frame.Barrier = kernelabi.BarrierID{Index: 3, Pos: "paged.go:109:3"}
			return true
		case 4:
			tr.Write(0, int(f.lane2))
			scores[f.lane2] = f.s11
		...
		case 5:
			f.pc = 6
			frame.Barrier = kernelabi.BarrierID{Index: 5, Pos: "paged.go:112:3"}
			return true
		case 6:
			f.stride15 = uint32(64)
			f.pc = 10
		...
		case 8:
			f.pc = 9
			frame.Barrier = kernelabi.BarrierID{Index: 8, Pos: "paged.go:118:4"}
			return true
		case 9:
			f.stride15 = (f.stride15 / uint32(2))
			f.pc = 10
		...
		case 12:
			f.pc = 13
			frame.Barrier = kernelabi.BarrierID{Index: 12, Pos: "paged.go:129:3"}
			return true
		case 13:
			tr.Write(0, int(f.lane2))
			scores[f.lane2] = f.e19
		...
		case 14:
			f.pc = 15
			frame.Barrier = kernelabi.BarrierID{Index: 14, Pos: "paged.go:132:3"}
			return true
		case 15:
			f.stride20 = uint32(64)
			f.pc = 19
		...
		case 17:
			f.pc = 18
			frame.Barrier = kernelabi.BarrierID{Index: 17, Pos: "paged.go:138:4"}
			return true
		case 18:
			f.stride20 = (f.stride20 / uint32(2))
			f.pc = 19
...
var AttentionDecodePagedKernel = kernelabi.Kernel{
	...
	Digest:    "87da262a432973165978eb4facd3fe26",
	Generator: kernelabi.Version,
	MSL: `#include <metal_stdlib>
using namespace metal;
#pragma METAL fp contract(off)
...
func attentionDecodePagedF16Coop(t accel.Thread, d PagedDims, q []float32, k []accel.Float16, v []accel.Float16, pages []uint32, lengths []uint32, out []float32, scores *[128]float32, red *[128]float32, f *attentionDecodePagedF16Frame, frame *kernelabi.Frame, tr *kernelabi.SharedTracker) bool {
	for {
		...
		case 3:
			f.pc = 4
			frame.Barrier = kernelabi.BarrierID{Index: 3, Pos: "paged.go:250:3"}
			return true
		case 4:
			tr.Write(0, int(f.lane2))
			scores[f.lane2] = f.s11
		...
		case 5:
			f.pc = 6
			frame.Barrier = kernelabi.BarrierID{Index: 5, Pos: "paged.go:253:3"}
			return true
		case 6:
			f.stride15 = uint32(64)
			f.pc = 10
		...
		case 8:
			f.pc = 9
			frame.Barrier = kernelabi.BarrierID{Index: 8, Pos: "paged.go:259:4"}
			return true
		case 9:
			f.stride15 = (f.stride15 / uint32(2))
			f.pc = 10
		...
		case 12:
			f.pc = 13
			frame.Barrier = kernelabi.BarrierID{Index: 12, Pos: "paged.go:270:3"}
			return true
		case 13:
			tr.Write(0, int(f.lane2))
			scores[f.lane2] = f.e19
		...
		case 14:
			f.pc = 15
			frame.Barrier = kernelabi.BarrierID{Index: 14, Pos: "paged.go:273:3"}
			return true
		case 15:
			f.stride20 = uint32(64)
			f.pc = 19
		...
		case 17:
			f.pc = 18
			frame.Barrier = kernelabi.BarrierID{Index: 17, Pos: "paged.go:279:4"}
			return true
		case 18:
			f.stride20 = (f.stride20 / uint32(2))
			f.pc = 19
...
var AttentionDecodePagedF16Kernel = kernelabi.Kernel{
	...
	Digest:    "8d54003fcacb55ece1bb451f9c13cf69",
	Generator: kernelabi.Version,
	MSL: `#include <metal_stdlib>
using namespace metal;
#pragma METAL fp contract(off)
