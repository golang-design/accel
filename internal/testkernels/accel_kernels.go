...
// pc before continuing is the jump, which is explicit because a loop's states
// do not run in numeric order.
func attentionDecodePagedCoop(t accel.Thread, d PagedDims, q []float32, k []float32, v []float32, pages []uint32, out []float32, scores *[128]float32, red *[128]float32, f *attentionDecodePagedFrame, frame *accel.KernelFrame, tr *accel.KernelSharedTracker) bool {
	for {
		switch f.pc {
		case 0:
			f.h0 = t.GroupID().X
		...
		case 1:
			f.pc = 2
			frame.Barrier = accel.KernelBarrierID{Index: 1, Pos: "paged.go:76:2"}
			return true
		case 2:
		...
		case 4:
			f.pc = 5
			frame.Barrier = accel.KernelBarrierID{Index: 4, Pos: "paged.go:86:3"}
			return true
		case 5:
		...
		case 8:
			f.pc = 9
			frame.Barrier = accel.KernelBarrierID{Index: 8, Pos: "paged.go:89:2"}
			return true
		case 9:
			f.e15 = float32(0)
			if f.lane1 < d.KVLen {
		...
		case 10:
			f.pc = 11
			frame.Barrier = accel.KernelBarrierID{Index: 10, Pos: "paged.go:97:2"}
			return true
		case 11:
		...
		case 13:
			f.pc = 14
			frame.Barrier = accel.KernelBarrierID{Index: 13, Pos: "paged.go:103:3"}
			return true
		case 14:
...
var AttentionDecodePagedKernel = accel.Kernel{
...
`,
	...
	Uniforms: []accel.KernelUniform{
		{Name: "d", Type: "PagedDims", Size: 32, Encode: func(dst []byte, v any) error {
			return accel.EncodeKernelUniform(dst, v, PagedDimsCodec{}.Encode)
		}},
	},
	Cooperative: func(t accel.Thread, a accel.KernelArgs, slot *accel.KernelFrame) bool {
		...
		return attentionDecodePagedCoop(t, accel.KernelUniformValue[PagedDims](a, 0), accel.KernelSlice[float32](a, 0), accel.KernelSlice[float32](a, 1), accel.KernelSlice[float32](a, 2), accel.KernelSlice[uint32](a, 3), accel.KernelSlice[float32](a, 4), accel.KernelShared[[128]float32](a, 0), accel.KernelShared[[128]float32](a, 1), f, slot, slot.Shared)
	},
}
...
// pc before continuing is the jump, which is explicit because a loop's states
// do not run in numeric order.
func topKMaskCoop(t accel.Thread, d TopDims, weights []float32, out []float32, best *[128]float32, at *[128]uint32, f *topKMaskFrame, frame *accel.KernelFrame, tr *accel.KernelSharedTracker) bool {
	for {
		switch f.pc {
		case 0:
			f.lane0 = t.LocalID().X
		...
		case 3:
			f.pc = 4
			frame.Barrier = accel.KernelBarrierID{Index: 3, Pos: "topk.go:97:3"}
			return true
		case 4:
			f.stride11 = uint32(64)
			f.pc = 8
		...
		case 6:
			f.pc = 7
			frame.Barrier = accel.KernelBarrierID{Index: 6, Pos: "topk.go:110:4"}
			return true
		case 7:
			f.stride11 = (f.stride11 / uint32(2))
			f.pc = 8
		...
		case 10:
			f.pc = 11
			frame.Barrier = accel.KernelBarrierID{Index: 10, Pos: "topk.go:114:3"}
			return true
		case 11:
			f.r4 = (f.r4 + uint32(1))
			f.pc = 12
...
var TopKMaskKernel = accel.Kernel{
	Name:          "TopKMask",
	WorkgroupSize: accel.ID3{X: 128, Y: 1, Z: 1},
	Bindings: []accel.KernelBinding{
		{Name: "weights", DType: accel.KernelF32, Access: accel.KernelRead},
		{Name: "out", DType: accel.KernelF32, Access: accel.KernelWrite},
	},
...
`,
	...
	Uniforms: []accel.KernelUniform{
		{Name: "d", Type: "TopDims", Size: 16, Encode: func(dst []byte, v any) error {
			return accel.EncodeKernelUniform(dst, v, TopDimsCodec{}.Encode)
		}},
	},
	Cooperative: func(t accel.Thread, a accel.KernelArgs, slot *accel.KernelFrame) bool {
		...
		return topKMaskCoop(t, accel.KernelUniformValue[TopDims](a, 0), accel.KernelSlice[float32](a, 0), accel.KernelSlice[float32](a, 1), accel.KernelShared[[128]float32](a, 0), accel.KernelShared[[128]uint32](a, 1), f, slot, slot.Shared)
	},
}
...
// pc before continuing is the jump, which is explicit because a loop's states
// do not run in numeric order.
func topPMaskCoop(t accel.Thread, d TopDims, weights []float32, out []float32, best *[128]float32, at *[128]uint32, f *topPMaskFrame, frame *accel.KernelFrame, tr *accel.KernelSharedTracker) bool {
	for {
		switch f.pc {
		case 0:
			f.lane0 = t.LocalID().X
		...
		case 1:
			f.pc = 2
			frame.Barrier = accel.KernelBarrierID{Index: 1, Pos: "topk.go:157:2"}
			return true
		case 2:
			f.stride3 = uint32(64)
			f.pc = 6
		...
		case 4:
			f.pc = 5
			frame.Barrier = accel.KernelBarrierID{Index: 4, Pos: "topk.go:162:3"}
			return true
		case 5:
		...
		case 8:
			f.pc = 9
			frame.Barrier = accel.KernelBarrierID{Index: 8, Pos: "topk.go:165:2"}
			return true
		case 9:
		...
		case 12:
			f.pc = 13
			frame.Barrier = accel.KernelBarrierID{Index: 12, Pos: "topk.go:205:3"}
			return true
		case 13:
			f.stride15 = uint32(64)
			f.pc = 17
		...
		case 15:
			f.pc = 16
			frame.Barrier = accel.KernelBarrierID{Index: 15, Pos: "topk.go:218:4"}
			return true
		case 16:
			f.stride15 = (f.stride15 / uint32(2))
			f.pc = 17
		...
		case 19:
			f.pc = 20
			frame.Barrier = accel.KernelBarrierID{Index: 19, Pos: "topk.go:228:3"}
			return true
		case 20:
			f.r8 = (f.r8 + uint32(1))
			f.pc = 21
...
var TopPMaskKernel = accel.Kernel{
	Name:          "TopPMask",
	WorkgroupSize: accel.ID3{X: 128, Y: 1, Z: 1},
	Bindings: []accel.KernelBinding{
		{Name: "weights", DType: accel.KernelF32, Access: accel.KernelRead},
...
`,
	...
	Cooperative: func(t accel.Thread, a accel.KernelArgs, slot *accel.KernelFrame) bool {
		...
		return topPMaskCoop(t, accel.KernelUniformValue[TopDims](a, 0), accel.KernelSlice[float32](a, 0), accel.KernelSlice[float32](a, 1), accel.KernelShared[[128]float32](a, 0), accel.KernelShared[[128]uint32](a, 1), f, slot, slot.Shared)
	},
}
