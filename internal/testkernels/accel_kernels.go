...
func attentionPrefillPagedCoop(t accel.Thread, d PagedPrefillDims, q []float32, k []float32, v []float32, pages []uint32, lengths []uint32, out []float32, scores *[128]float32, red *[128]float32, f *attentionPrefillPagedFrame, frame *kernelabi.Frame, tr *kernelabi.SharedTracker) bool {
	for {
		...
		case 3:
			f.pc = 4
			frame.Barrier = kernelabi.BarrierID{Index: 3, Pos: "prefill.go:337:3"}
			return true
		case 4:
			tr.Write(0, int(f.lane2))
			scores[f.lane2] = f.score14
		...
		case 5:
			f.pc = 6
			frame.Barrier = kernelabi.BarrierID{Index: 5, Pos: "prefill.go:340:3"}
			return true
		case 6:
		...
		case 8:
			f.pc = 9
			frame.Barrier = kernelabi.BarrierID{Index: 8, Pos: "prefill.go:346:4"}
			return true
		case 9:
		...
		case 12:
			f.pc = 13
			frame.Barrier = kernelabi.BarrierID{Index: 12, Pos: "prefill.go:359:3"}
			return true
		case 13:
			tr.Write(0, int(f.lane2))
		...
		case 14:
			f.pc = 15
			frame.Barrier = kernelabi.BarrierID{Index: 14, Pos: "prefill.go:362:3"}
			return true
		case 15:
		...
		case 17:
			f.pc = 18
			frame.Barrier = kernelabi.BarrierID{Index: 17, Pos: "prefill.go:368:4"}
			return true
		case 18:
