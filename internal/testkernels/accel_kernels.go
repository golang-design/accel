...
var AddKernel = kernelabi.Kernel{
	...
	Digest:           "4dc8b21039b2f540da562dd67447e693",
...
var HistogramKernel = kernelabi.Kernel{
	...
	Digest:    "668336bdf49f0b74ce459eecded77057",
	Generator: kernelabi.Version,
	MSL: `#include <metal_stdlib>
using namespace metal;
#pragma METAL fp contract(off)
...
var AtomicOpsKernel = kernelabi.Kernel{
	...
	Digest:    "e882720bbad9f5d19e38b91488640328",
	Generator: kernelabi.Version,
	MSL: `#include <metal_stdlib>
using namespace metal;
#pragma METAL fp contract(off)
...
var CountWorkgroupsKernel = kernelabi.Kernel{
	...
	Digest:    "efd3d53f7f500dac3431a7f9c223c9a4",
	Generator: kernelabi.Version,
	MSL: `#include <metal_stdlib>
using namespace metal;
#pragma METAL fp contract(off)
...
var AtomicOpsI32Kernel = kernelabi.Kernel{
	...
	Digest:    "b1a19c5d326ca79c53aea057b92c5276",
	Generator: kernelabi.Version,
	MSL: `#include <metal_stdlib>
using namespace metal;
#pragma METAL fp contract(off)
...
var AtomicAddF32Kernel = kernelabi.Kernel{
	...
	Digest:    "39ded1fba5e5b096169b2d9e46ea4c93",
	Generator: kernelabi.Version,
	Caps:      128,
	Flat: func(t accel.Thread, a kernelabi.Args) {
...
var AttentionDecodeKernel = kernelabi.Kernel{
	...
	Digest:    "a1f6796fba64f9479f46e4640b7b633e",
	Generator: kernelabi.Version,
	MSL: `#include <metal_stdlib>
using namespace metal;
#pragma METAL fp contract(off)
...
var AttentionDecodeF16Kernel = kernelabi.Kernel{
	...
	Digest:    "35f7379469d1a022024b50a78531de17",
	Generator: kernelabi.Version,
	MSL: `#include <metal_stdlib>
using namespace metal;
#pragma METAL fp contract(off)
...
var BallotKernel = kernelabi.Kernel{
	...
	Digest:           "60bc9bed1675f6cb07cd0b974cd165a0",
	Generator:        kernelabi.Version,
	Caps:             5,
	OrderIndependent: true,
	Suspensions:      1,
...
var PublishStorageKernel = kernelabi.Kernel{
	...
	Digest:    "c676bb4f53c2f08133fd7560b91817e7",
	Generator: kernelabi.Version,
	MSL: `#include <metal_stdlib>
using namespace metal;
#pragma METAL fp contract(off)
...
var PublishSharedKernel = kernelabi.Kernel{
	...
	Digest:    "0a8968d0961f51cfe54a91be3ad9d725",
	Generator: kernelabi.Version,
	MSL: `#include <metal_stdlib>
using namespace metal;
#pragma METAL fp contract(off)
...
var SubgroupPublishKernel = kernelabi.Kernel{
	...
	Digest:    "d1c8ab402c5d5e38188b4b0de6b8f6b6",
	Generator: kernelabi.Version,
	MSL: `#include <metal_stdlib>
using namespace metal;
#pragma METAL fp contract(off)
...
var SubgroupStaggerKernel = kernelabi.Kernel{
	...
	Digest:    "7e1af2527a02959024789961f369bf15",
	Generator: kernelabi.Version,
	MSL: `#include <metal_stdlib>
using namespace metal;
#pragma METAL fp contract(off)
...
var AttentionDecodeBatchedKernel = kernelabi.Kernel{
	...
	Digest:    "4e01d7499ab08cf9f849f921223152e5",
	Generator: kernelabi.Version,
	MSL: `#include <metal_stdlib>
using namespace metal;
#pragma METAL fp contract(off)
...
var CastF32ToF16Kernel = kernelabi.Kernel{
	...
	Digest:           "310712adee335416db32aafc898a60ec",
	Generator:        kernelabi.Version,
	OrderIndependent: true,
	MSL: `#include <metal_stdlib>
using namespace metal;
...
var CastF16ToF32Kernel = kernelabi.Kernel{
	...
	Digest:           "4be5cd1df306e4e91b64b02f494b11e5",
	Generator:        kernelabi.Version,
	OrderIndependent: true,
	MSL: `#include <metal_stdlib>
using namespace metal;
...
var CastBF16ToF32Kernel = kernelabi.Kernel{
	...
	Digest:           "3a50223c1b77eab7d4fa45cc4ad309d4",
	Generator:        kernelabi.Version,
	OrderIndependent: true,
	MSL: `#include <metal_stdlib>
using namespace metal;
...
var SaturatingConvertKernel = kernelabi.Kernel{
	...
	Digest:           "51780b71cdedabf0242487eec8052cb7",
	Generator:        kernelabi.Version,
	OrderIndependent: true,
	MSL: `#include <metal_stdlib>
using namespace metal;
...
var ExchangeKernel = kernelabi.Kernel{
	...
	Digest:    "1a76e1ffe3730b20a0d6109e78f79b28",
	Generator: kernelabi.Version,
	MSL: `#include <metal_stdlib>
using namespace metal;
#pragma METAL fp contract(off)
...
var ReduceLoopKernel = kernelabi.Kernel{
	...
	Digest:    "ca7a7312bdbfdd0c00564e99c7565a67",
	Generator: kernelabi.Version,
	MSL: `#include <metal_stdlib>
using namespace metal;
#pragma METAL fp contract(off)
...
var ReduceUnrolledKernel = kernelabi.Kernel{
	...
	Digest:    "38a22101c3ec55813aa29103a63ee53a",
	Generator: kernelabi.Version,
	MSL: `#include <metal_stdlib>
using namespace metal;
#pragma METAL fp contract(off)
...
var DispatchShapeKernel = kernelabi.Kernel{
	...
	Digest:           "b7db7bf3aefe8ff1878b0538d56605a9",
	Generator:        kernelabi.Version,
	OrderIndependent: true,
	MSL: `#include <metal_stdlib>
using namespace metal;
...
var ShapeBoundedSumKernel = kernelabi.Kernel{
	...
	Digest:    "4713a5f0e8210dd271c84da00eaa5517",
	Generator: kernelabi.Version,
	MSL: `#include <metal_stdlib>
using namespace metal;
#pragma METAL fp contract(off)
...
var ElemAddKernel = kernelabi.Kernel{
	...
	Digest:           "758f5a6ab57d9ee7f0bbf590702196ad",
	Generator:        kernelabi.Version,
	OrderIndependent: true,
	MSL: `#include <metal_stdlib>
using namespace metal;
...
var ElemMulKernel = kernelabi.Kernel{
	...
	Digest:           "662c687afa77b3842d9e6ec16520df63",
	Generator:        kernelabi.Version,
	OrderIndependent: true,
	MSL: `#include <metal_stdlib>
using namespace metal;
...
var ElemScaleKernel = kernelabi.Kernel{
	...
	Digest:           "b73574dd167f2b196f09734c508dbd28",
	Generator:        kernelabi.Version,
	OrderIndependent: true,
	MSL: `#include <metal_stdlib>
using namespace metal;
...
var SiLUKernel = kernelabi.Kernel{
	...
	Digest:           "95d3ff8f351ed7dbd19fa0810dffaac7",
	Generator:        kernelabi.Version,
	OrderIndependent: true,
	MSL: `#include <metal_stdlib>
using namespace metal;
...
var SwiGLUKernel = kernelabi.Kernel{
	...
	Digest:           "7b815d0829f6eef022f26eb06ecd1fce",
	Generator:        kernelabi.Version,
	OrderIndependent: true,
	MSL: `#include <metal_stdlib>
using namespace metal;
...
var GatherRowsKernel = kernelabi.Kernel{
	...
	Digest:           "7bfb1bbc2de052f6125f336c069c6363",
	Generator:        kernelabi.Version,
	OrderIndependent: true,
	MSL: `#include <metal_stdlib>
using namespace metal;
...
var GatherRowsF16Kernel = kernelabi.Kernel{
	...
	Digest:           "c16a3267e9c3a8874db81afcd7632604",
	Generator:        kernelabi.Version,
	OrderIndependent: true,
	MSL: `#include <metal_stdlib>
using namespace metal;
...
var ScatterRowsKernel = kernelabi.Kernel{
	...
	Digest:           "cdbaa7d11a0aabd1cf84573b54e67974",
	Generator:        kernelabi.Version,
	OrderIndependent: true,
	MSL: `#include <metal_stdlib>
using namespace metal;
...
var ScatterRowsF16Kernel = kernelabi.Kernel{
	...
	Digest:           "aeb995716e3dddacb0b8842cabd9d7c3",
	Generator:        kernelabi.Version,
	OrderIndependent: true,
	MSL: `#include <metal_stdlib>
using namespace metal;
...
var RoPEKernel = kernelabi.Kernel{
	...
	Digest:           "65540c88fec856f1e46df07fb952cdba",
	Generator:        kernelabi.Version,
	OrderIndependent: true,
	MSL: `#include <metal_stdlib>
using namespace metal;
...
var ElemBiasKernel = kernelabi.Kernel{
	...
	Digest:           "36b9ae48cc57dfbced9796697d44c2e3",
	Generator:        kernelabi.Version,
	OrderIndependent: true,
	MSL: `#include <metal_stdlib>
using namespace metal;
...
var MatMulTiledKernel = kernelabi.Kernel{
	...
	Digest:    "4ba9b04a6ed6f807880e99d55b4d49f2",
	Generator: kernelabi.Version,
	MSL: `#include <metal_stdlib>
using namespace metal;
#pragma METAL fp contract(off)
...
var MatMulTiledF32Kernel = kernelabi.Kernel{
	...
	Digest:    "3d4d60e4c35d88f1ba5e40637cf677d1",
	Generator: kernelabi.Version,
	MSL: `#include <metal_stdlib>
using namespace metal;
#pragma METAL fp contract(off)
...
var MatMulTiledF32F16Kernel = kernelabi.Kernel{
	...
	Digest:    "e8732e1d29cf7c9c7a4f6091d8e78dce",
	Generator: kernelabi.Version,
	MSL: `#include <metal_stdlib>
using namespace metal;
#pragma METAL fp contract(off)
...
var GroupedMatVecKernel = kernelabi.Kernel{
	...
	Digest:    "a9e9a9959b8d7ecff0b0fb62b122d43f",
	Generator: kernelabi.Version,
	MSL: `#include <metal_stdlib>
using namespace metal;
#pragma METAL fp contract(off)
...
var GroupedMatMulKernel = kernelabi.Kernel{
	...
	Digest:    "e869f99db4719ed5ca0aee6d381ae28a",
	Generator: kernelabi.Version,
	MSL: `#include <metal_stdlib>
using namespace metal;
#pragma METAL fp contract(off)
...
var QuantMatVecInt4Kernel = kernelabi.Kernel{
	...
	Digest:    "f6ce1cdffbe3052f69b7d8c37e69a746",
	Generator: kernelabi.Version,
	MSL: `#include <metal_stdlib>
using namespace metal;
#pragma METAL fp contract(off)
...
var QuantMatMulInt4Kernel = kernelabi.Kernel{
	...
	Digest:    "52aa699ec46ad5525fa16779c72d4073",
	Generator: kernelabi.Version,
	MSL: `#include <metal_stdlib>
using namespace metal;
#pragma METAL fp contract(off)
...
var IntReduceKernel = kernelabi.Kernel{
	...
	Digest:    "b0b1226dc4fde5f18c1079f9b22dfa0e",
	Generator: kernelabi.Version,
	MSL: `#include <metal_stdlib>
using namespace metal;
#pragma METAL fp contract(off)
...
var BitReduceKernel = kernelabi.Kernel{
	...
	Digest:    "82aace91cdd9cd1208d6fa8d23bf6f5b",
	Generator: kernelabi.Version,
	MSL: `#include <metal_stdlib>
using namespace metal;
#pragma METAL fp contract(off)
...
var MulReduceKernel = kernelabi.Kernel{
	...
	Digest:    "5dc4b0bbdc9013a2a79b6c58665588c2",
	Generator: kernelabi.Version,
	MSL: `#include <metal_stdlib>
using namespace metal;
#pragma METAL fp contract(off)
...
var LinearAttentionKernel = kernelabi.Kernel{
	...
	Digest:           "fc51202f8254fe6acf42ce9e2c717bd7",
	Generator:        kernelabi.Version,
	OrderIndependent: true,
	MSL: `#include <metal_stdlib>
using namespace metal;
...
var MatVecKernel = kernelabi.Kernel{
	...
	Digest:    "04d8d742fe6267e22a12bc9951368a5d",
	Generator: kernelabi.Version,
	MSL: `#include <metal_stdlib>
using namespace metal;
#pragma METAL fp contract(off)
...
var QuantMatVecKernel = kernelabi.Kernel{
	...
	Digest:    "d673233f98624f3595ca1373dc77dfb5",
	Generator: kernelabi.Version,
	MSL: `#include <metal_stdlib>
using namespace metal;
#pragma METAL fp contract(off)
...
func quantMatVecF32Coop(t accel.Thread, d GEMMDims, a []float32, bq []int8, bs []accel.Float16, out []float32, sh *[128]float32, f *quantMatVecF32Frame, frame *kernelabi.Frame, tr *kernelabi.SharedTracker) bool {
	for {
			...
			if f.col0 < d.N {
				{
					...
					for ; f.k3 < d.K; f.k3 = (f.k3 + uint32(128)) {
						...
						f.q5 = float32(bq[f.w4])
						f.s6 = bs[(f.w4 / uint32(32))].F32()
						f.acc2 = float32(f.acc2 + float32(a[f.k3]*float32(f.q5*f.s6)))
					}
				}
			}
			tr.Write(0, int(f.lid1))
		...
		case 1:
			f.pc = 2
			frame.Barrier = kernelabi.BarrierID{Index: 1, Pos: "matvec.go:140:2"}
			return true
		case 2:
			f.stride7 = uint32(64)
			f.pc = 6
		...
		case 4:
			f.pc = 5
			frame.Barrier = kernelabi.BarrierID{Index: 4, Pos: "matvec.go:146:3"}
			return true
		case 5:
			f.stride7 = (f.stride7 / uint32(2))
			f.pc = 6
...
var QuantMatVecF32Kernel = kernelabi.Kernel{
	...
	Digest:    "12c1602866ae966d5775d244399c1e51",
	Generator: kernelabi.Version,
	MSL: `#include <metal_stdlib>
using namespace metal;
#pragma METAL fp contract(off)
...
func linearTiledCoop(t accel.Thread, d GEMMDims, a []accel.Float16, b []accel.Float16, bias []float32, out []float32, tileA *[128]accel.Float16, tileB *[256]accel.Float16, f *linearTiledFrame, frame *kernelabi.Frame, tr *kernelabi.SharedTracker) bool {
	for {
		...
		case 3:
			f.pc = 4
			frame.Barrier = kernelabi.BarrierID{Index: 3, Pos: "matvec.go:201:3"}
			return true
		case 4:
			{
				f.k11 = uint32(0)
		...
		case 5:
			f.pc = 6
			frame.Barrier = kernelabi.BarrierID{Index: 5, Pos: "matvec.go:209:3"}
			return true
		case 6:
			f.k07 = (f.k07 + uint32(16))
			f.pc = 7
...
var LinearTiledKernel = kernelabi.Kernel{
	...
	Digest:    "bee7543a62ae34d6489f2a90dee53d18",
	Generator: kernelabi.Version,
	MSL: `#include <metal_stdlib>
using namespace metal;
#pragma METAL fp contract(off)
...
var RMSNormKernel = kernelabi.Kernel{
	...
	Digest:    "52c87ac8aa84086319b3f9a7625ff572",
	Generator: kernelabi.Version,
	MSL: `#include <metal_stdlib>
using namespace metal;
#pragma METAL fp contract(off)
...
var SoftmaxKernel = kernelabi.Kernel{
	...
	Digest:    "20136104a91ccf04139c1acde280aa02",
	Generator: kernelabi.Version,
	MSL: `#include <metal_stdlib>
using namespace metal;
#pragma METAL fp contract(off)
...
var PackKernel = kernelabi.Kernel{
	...
	Digest:           "b02ba579192f5943ee725fa82f233b44",
	Generator:        kernelabi.Version,
	OrderIndependent: true,
	MSL: `#include <metal_stdlib>
using namespace metal;
...
var AttentionDecodePagedKernel = kernelabi.Kernel{
	...
	Digest:    "5c1ae4f01bf2f867e4e7ff6270db248e",
	Generator: kernelabi.Version,
	MSL: `#include <metal_stdlib>
using namespace metal;
#pragma METAL fp contract(off)
...
var AttentionDecodePagedF16Kernel = kernelabi.Kernel{
	...
	Digest:    "eb9005802b50df6a2a365bbac53ebaec",
	Generator: kernelabi.Version,
	MSL: `#include <metal_stdlib>
using namespace metal;
#pragma METAL fp contract(off)
...
var AttentionPrefillPagedF16Kernel = kernelabi.Kernel{
	...
	Digest:    "3d919fe66b97d10d19b50f8cf8cc5c7b",
	Generator: kernelabi.Version,
	MSL: `#include <metal_stdlib>
using namespace metal;
#pragma METAL fp contract(off)
...
var PenaltyCountKernel = kernelabi.Kernel{
	...
	Digest:    "1cc9a313300ed75624be609afcfed419",
	Generator: kernelabi.Version,
	MSL: `#include <metal_stdlib>
using namespace metal;
#pragma METAL fp contract(off)
...
var PenaltyApplyKernel = kernelabi.Kernel{
	...
	Digest:           "aaa5f6e5556b8d195ff97674d94adb92",
	Generator:        kernelabi.Version,
	OrderIndependent: true,
	MSL: `#include <metal_stdlib>
using namespace metal;
...
var PenaltyClearKernel = kernelabi.Kernel{
	...
	Digest:           "c5f070bbac0190fa78aea9962c2d9d92",
	Generator:        kernelabi.Version,
	OrderIndependent: true,
	MSL: `#include <metal_stdlib>
using namespace metal;
...
var AttentionPrefillKernel = kernelabi.Kernel{
	...
	Digest:    "f131ae5cd3d74ad3d068d7aa1ced8fdf",
	Generator: kernelabi.Version,
	MSL: `#include <metal_stdlib>
using namespace metal;
#pragma METAL fp contract(off)
...
var AttentionPrefillF16Kernel = kernelabi.Kernel{
	...
	Digest:    "3ec3371dec78fa14a2c181a1626ff2f9",
	Generator: kernelabi.Version,
	MSL: `#include <metal_stdlib>
using namespace metal;
#pragma METAL fp contract(off)
...
var AttentionPrefillPagedKernel = kernelabi.Kernel{
	...
	Digest:    "3587e6459cc9e382e28d7cfc9d619b08",
	Generator: kernelabi.Version,
	MSL: `#include <metal_stdlib>
using namespace metal;
#pragma METAL fp contract(off)
...
var QuantMatMulKernel = kernelabi.Kernel{
	...
	Digest:           "92d05d0471fb30d608cfd10fcb74916b",
	Generator:        kernelabi.Version,
	OrderIndependent: true,
	MSL: `#include <metal_stdlib>
using namespace metal;
...
var QuantRowsKernel = kernelabi.Kernel{
	...
	Digest:           "397d69beb980e16ba15486a241b57798",
	Generator:        kernelabi.Version,
	OrderIndependent: true,
	MSL: `#include <metal_stdlib>
using namespace metal;
...
var QuantMatMulF32Kernel = kernelabi.Kernel{
	...
	Digest:           "f4b55ef3027804518271620649ea38ab",
	Generator:        kernelabi.Version,
	OrderIndependent: true,
	MSL: `#include <metal_stdlib>
using namespace metal;
...
var AttentionRaggedKernel = kernelabi.Kernel{
	...
	Digest:    "05995debb9ba72c94c26a9d0c65ba248",
	Generator: kernelabi.Version,
	MSL: `#include <metal_stdlib>
using namespace metal;
#pragma METAL fp contract(off)
...
var AttentionRaggedF16Kernel = kernelabi.Kernel{
	...
	Digest:    "331f4d76d4b7e0c65ba2d8fb719d4d70",
	Generator: kernelabi.Version,
	MSL: `#include <metal_stdlib>
using namespace metal;
#pragma METAL fp contract(off)
...
var SegmentSumKernel = kernelabi.Kernel{
	...
	Digest:           "786ff1f5c3ee3103899a5c8b54e622b6",
	Generator:        kernelabi.Version,
	OrderIndependent: true,
	MSL: `#include <metal_stdlib>
using namespace metal;
...
var CountAboveKernel = kernelabi.Kernel{
	...
	Digest:           "4bc0f3335f7e82930c720a59ad5fbc7a",
	Generator:        kernelabi.Version,
	OrderIndependent: true,
	MSL: `#include <metal_stdlib>
using namespace metal;
...
var NormalizeKernel = kernelabi.Kernel{
	...
	Digest:           "35970a93cdbea1fe6bbe01c17d029ff9",
	Generator:        kernelabi.Version,
	OrderIndependent: true,
	MSL: `#include <metal_stdlib>
using namespace metal;
...
var ReduceSumKernel = kernelabi.Kernel{
	...
	Digest:    "d122fe3d505ab04067c06e920745f821",
	Generator: kernelabi.Version,
	MSL: `#include <metal_stdlib>
using namespace metal;
#pragma METAL fp contract(off)
...
var SampleArgmaxKernel = kernelabi.Kernel{
	...
	Digest:    "e33001117178aa1949216d3cbb4c8c67",
	Generator: kernelabi.Version,
	MSL: `#include <metal_stdlib>
using namespace metal;
#pragma METAL fp contract(off)
...
var SampleCategoricalKernel = kernelabi.Kernel{
	...
	Digest:           "0357eface10b5d7ad1439ab4329b24cf",
	Generator:        kernelabi.Version,
	OrderIndependent: true,
	MSL: `#include <metal_stdlib>
using namespace metal;
...
var ScaleKernel = kernelabi.Kernel{
	...
	Digest:           "13cf18401968f78b28b1307614944a88",
	Generator:        kernelabi.Version,
	OrderIndependent: true,
	MSL: `#include <metal_stdlib>
using namespace metal;
...
var TransformKernel = kernelabi.Kernel{
	...
	Digest:           "d581dbbc1f5b1f59a4ca6762b4934b3b",
	Generator:        kernelabi.Version,
	OrderIndependent: true,
	MSL: `#include <metal_stdlib>
using namespace metal;
...
var SegmentOffsetsKernel = kernelabi.Kernel{
	...
	Digest:           "5b2f0d1500d7af293993e58283711fde",
	Generator:        kernelabi.Version,
	OrderIndependent: true,
	MSL: `#include <metal_stdlib>
using namespace metal;
...
`,
	Digest:    "084a75169788ef9c2cc19306f2870b9b",
	Generator: kernelabi.Version,
}
...
`,
	Digest:    "d3586add928e2a4690caef246c00f986",
	Generator: kernelabi.Version,
}
...
`,
	Digest:    "4945ef53c61b2bae4226ce7d9e004560",
	Generator: kernelabi.Version,
}
...
`,
	Digest:    "8e06567d7d220c5cc660d4540aaf3ca5",
	Generator: kernelabi.Version,
}
...
`,
	Digest:    "dc8dec4e37188efc53a1ce288de9cf71",
	Generator: kernelabi.Version,
}
...
`,
	Digest:    "ae49c8b7f16594260ae3a2bc50e8757a",
	Generator: kernelabi.Version,
}
...
`,
	Digest:    "87abfa7babd48a59a2539533e4f6492a",
	Generator: kernelabi.Version,
}
...
`,
	Digest:    "787b055080ea159fe2651262caa3f08d",
	Generator: kernelabi.Version,
}
...
`,
	Digest:    "5ea4d7eb637d94f4d53a54be39439ffd",
	Generator: kernelabi.Version,
}
...
`,
	Digest:    "e7a1367a5de81308100355dc44a39642",
	Generator: kernelabi.Version,
}
...
`,
	Digest:    "fce7d70a82309ba1b6d338ccb9e47a32",
	Generator: kernelabi.Version,
}
...
`,
	Digest:    "e1bbb5e9ecebd1d7f7cbdc1c5c033780",
	Generator: kernelabi.Version,
}
...
var SubgroupReduceKernel = kernelabi.Kernel{
	...
	Digest:    "ca380cfb477ab045e4177671dc8b5ae7",
	Generator: kernelabi.Version,
	MSL: `#include <metal_stdlib>
using namespace metal;
#pragma METAL fp contract(off)
...
var SubgroupReduceFallbackKernel = kernelabi.Kernel{
	...
	Digest:           "8b3dff22f85a8af9bb568617c41150eb",
	Generator:        kernelabi.Version,
	OrderIndependent: true,
	MSL: `#include <metal_stdlib>
using namespace metal;
...
var SubgroupShuffleMixKernel = kernelabi.Kernel{
	...
	Digest:    "8548ce8f940c9121ec2e0405879978cc",
	Generator: kernelabi.Version,
	MSL: `#include <metal_stdlib>
using namespace metal;
#pragma METAL fp contract(off)
...
var SubgroupShuffleMixFallbackKernel = kernelabi.Kernel{
	...
	Digest:           "4b4c72c36b7fa6d68b0214696eb6be65",
	Generator:        kernelabi.Version,
	OrderIndependent: true,
	MSL: `#include <metal_stdlib>
using namespace metal;
...
var SubgroupScanKernel = kernelabi.Kernel{
	...
	Digest:    "1639bcc3b5a6788d8859a941d78b2849",
	Generator: kernelabi.Version,
	MSL: `#include <metal_stdlib>
using namespace metal;
#pragma METAL fp contract(off)
...
var SubgroupScanFallbackKernel = kernelabi.Kernel{
	...
	Digest:           "b2a1a73ca9c21cd644a269ef13e246f2",
	Generator:        kernelabi.Version,
	OrderIndependent: true,
	MSL: `#include <metal_stdlib>
using namespace metal;
...
var TopKMaskKernel = kernelabi.Kernel{
	...
	Digest:    "5c87e2bbf9decb63b484ba36cd80bfdc",
	Generator: kernelabi.Version,
	MSL: `#include <metal_stdlib>
using namespace metal;
#pragma METAL fp contract(off)
...
var TopPMaskKernel = kernelabi.Kernel{
	...
	Digest:    "5a67bcedd5b4b9132c4a4e6d26b0aa41",
	Generator: kernelabi.Version,
	MSL: `#include <metal_stdlib>
using namespace metal;
#pragma METAL fp contract(off)
