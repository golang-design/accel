...
| [047-linear-attention.md](047-linear-attention.md) | Drafted | A matrix state per sequence and a scan over 046's segmented extent, so hybrid models whose three-in-four layers are not softmax attention become expressible |
