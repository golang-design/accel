...
| [048-int4.md](048-int4.md) | Drafted | An asymmetric grouped 4-bit weight representation and its derived bound, which decides whether a 27B-class model fits one device (accel issue 22) |
